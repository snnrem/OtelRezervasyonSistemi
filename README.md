...
##### Bu ekrandan Veritabanındaki Yonetici tablomdan aldığım Kullanıcı Adı ve Şifre Değerlerini giriyorum.
![Ekran görüntüsü 2025-01-24 083341](https://github.com/user-attachments/assets/e78dda49-9481-4a41-a5c8-795157e18686)
#### Şifremi Unuttum Ekranı
##### Giriş ekranımdaki şifremi unuttum butonuna tıkladığımızda bu formun içine geliriz ve burada güvenlik kelimesini doğru girersek kullanıcı adı ve şifre bilgilerini güncelleyebiliyoruz.
![Ekran görüntüsü 2025-01-24 083359](https://github.com/user-attachments/assets/d86f574e-a231-40ba-a286-ddec69bf4232)
### Ana Ekran
##### Bu ekran ana sayfamız. Bu ekrandan yapmak istediğimiz işlemleri seçebiliriz. Öreneğin; müşteri işlemleri, personel işlemleri, oda işlemleri, yönetici işlemleri, finansal durum işlemleri, duyurular.
...
##### Bu ekrandan müşterileri ekleyebiliyorum. yan taraftaki ofa butonlarımın üstüne tıklayarak odaları seçiyorum. yeşil odalar boş odaları kırmızı odalar dolu odaları gösterir.
...
#####  Bu ekranda rezervasyon bilgilerini listViewin içinde görüntüleyebiliriz ve müşterileri arayabiliyoruz.
...
#####  Bu ekranda müşteri bilgilerini güncelleyebiliyorum.
...
#####  Bu ekranda rezervasyon iptal edebiliyorum.
...
##### Bu ekranda yeni personeller ekleyebiliyorum.
...
#####  Bu ekranda personel bilgilerini listViewin içinde görüntüleyebiliriz ve personelleri arayabiliyoruz.
...
#####  Bu ekranda personel bilgilerini Güncelleyebiliyoruz.
